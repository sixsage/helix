...
RESULTS_PATH = 'mlp\\1m_pointnet_second\\'
MODEL_PATH = 'pointnet_epoch_170.pth'
...
if __name__ == '__main__':
    ...
    print(result_mae)
    min_per_column = torch.min(dataset.targets, dim=0, keepdim=True)
    max_per_column = torch.max(dataset.targets, dim=0, keepdim=True)
